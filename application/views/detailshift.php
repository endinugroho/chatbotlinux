      ...
      <div class="container" style="margin-top: 30px;background-color:white;"><br>
        <div class="col-md-12"><?php if ($method=="Edit") $hasil="update"; else $hasil="simpan"; ?>
            <?php echo form_open('Shift/'.$hasil); ?> 
              ...
              <div class="form-group">                <label for="text">After Break</label>                <input type="text" name="afterbreak" value="<?php if ($method=="Edit") echo $dataperush->afterbreak; ?>" class="form-control" placeholder="Masukkan After Break">              </div> 
