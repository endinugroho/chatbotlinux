            ...
            <table id="tablesopir" class="table table-striped table-bordered" style="width:100%">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->typecontainer ?></td>
                    <td><?php echo $hasil->nocontainer ?></td>
                    <td><?php echo $hasil->pekerjaan ?></td>
                    <td><?php echo $hasil->retase ?></td>
                    <td><?php echo $hasil->status ?></td>
                    <td><a href="https://app.csblogistic.com/index.php/Mpostingspv/statusdocrepo/terima doc/<?php echo $hasil->idRateRepo; ?>" class="btn btn-md btn-success">Terima</a><a href="https://app.csblogistic.com/index.php/Mpostingspv/statusdocrepo/tolak doc/<?php echo $hasil->idRateRepo; ?>" class="btn btn-md btn-danger">Tolak</button></td>
                  </tr>
