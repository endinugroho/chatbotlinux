        ...
        <div class="col-md-12">
            <?php echo form_open('customer/update') ?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="namavendor" value="<?php echo $datacustomer->namavendor ?>" class="form-control" placeholder="Nama Customer">
                <input type="hidden" value="<?php echo $datacustomer->idVendor ?>" name="idVendor">
              </div>
 
              <div class="form-group">
                <label for="text">Alamat</label>
                <input type="text" name="alamat" value="<?php echo $datacustomer->alamat ?>" class="form-control" placeholder="Masukkan Alamat">
              </div>
 
              <div class="form-group">
                <label for="text">Kota</label>
                <input type="text" name="kota" value="<?php echo $datacustomer->kota ?>" class="form-control" placeholder="Masukkan Kota">
              </div>
 
              <div class="form-group">
                <label for="text">No HP</label>
                <input type="number" name="notelepon" value="<?php echo $datacustomer->notelepon ?>" class="form-control" placeholder="Masukkan No HP">
              </div>
 
              <div class="form-group">
                <label for="text">NPWP</label>
                <input type="number" name="npwp" value="<?php echo $datacustomer->npwp ?>" class="form-control" placeholder="Masukkan NPWP">
              </div>
