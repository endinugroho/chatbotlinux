...
<head>
  ...
  <title>System Informasi PMB | Dashboard</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        $main_menu = $this->db->get_where('menuapp2', array('ismainmenu' => 0));

        foreach ($main_menu->result() as $main) {

            // Query untuk mencari data sub menu

            $sub_menu = $this->db->get_where('menuapp2', array('ismainmenu' => $main->id));
