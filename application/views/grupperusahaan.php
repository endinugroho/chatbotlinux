  ...
  <div class="content-wrapper">
    ...
    <div class="container" style="margin-top: 30px">
		...
		<div class="col-sm-11" style="background-color:white;">
            ...
            <?php echo form_open('Grupperusahaan/update') ?>

 

              <div class="form-group">

                <label for="text">Nama Grup Perusahaan</label>

                <input type="text" name="nama" value="<?php echo $datagrupper->nama; ?>" class="form-control" placeholder="Nama Grup Perusahaan">
                <input type="hidden" name="id" value="<?php echo $datagrupper->id; ?>" class="form-control" placeholder="Nama Grup Perusahaan">
              ...
              <div class="form-group">
                ...
                <input type="text" name="deskripsi" value="<?php echo $datagrupper->deskripsi; ?>" class="form-control" placeholder="Deskripsi">
              ...
              <div class="form-group">
                ...
                <input type="text" name="pemilik" value="<?php echo $datagrupper->pemilik; ?>" class="form-control" placeholder="Nama Pemilik">
