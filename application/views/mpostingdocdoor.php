            ...
            <table id="tablesopir" class="table table-striped table-bordered" style="width:100%">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->muat ?></td>
                    <td><?php echo $hasil->ukuran ?></td>
                    <td><?php echo $hasil->retase ?></td>
                    <td><?php echo $hasil->status ?></td>
                    <td><a href="https://app.csblogistic.com/index.php/Mpostingspv/statusdocdoor/terima doc/<?php echo $hasil->idRateDoor; ?>" class="btn btn-md btn-success">Terima</a><a href="https://app.csblogistic.com/index.php/Mpostingspv/statusdocdoor/tolak doc/<?php echo $hasil->idRateDoor; ?>" class="btn btn-md btn-danger">Tolak</button></td>
                  </tr>
