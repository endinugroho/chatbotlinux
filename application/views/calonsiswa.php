  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <small>Daftar CalonSiswa sistem pmb</small>
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo base_url() ?>index.php/CalonSiswa/tambah/" class="btn btn-sm btn-success">Tambah CalonSiswa</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $hasil->asalsd; ?></td>
                  <td><a href="<?php echo base_url() ?>index.php/CalonSiswa/edit/<?php echo $hasil->id; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/CalonSiswa/hapus/<?php echo $hasil->id; ?>" class="btn btn-sm btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
