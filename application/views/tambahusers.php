...
<head>
  ...
  <title>CSB Logistic | Tambah Users</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container" style="margin-top: 30px">
        <div class="col-md-12">
            <?php echo form_open('users/simpan') ?>
 
              <div class="form-group">
                <label for="text">Nama User</label>
                <input type="text" name="namausers" class="form-control" placeholder="Masukkan Nama" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">User Login</label>
                <input type="text" name="userlogin" class="form-control" placeholder="Masukkan User Login" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">Password</label>
                <input type="text" name="password" class="form-control" placeholder="Masukkan Password" size="50" >
              </div>
 
              <div class="form-group">
                <label for="text">Email</label>
                <input type="text" name="email" class="form-control" placeholder="Masukkan Email" size="50" >
              </div>
