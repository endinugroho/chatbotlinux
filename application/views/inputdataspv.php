  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Operasional dan SPV Entri Data</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="container mt-3">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#manpower">Man Power</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#repo">Repo</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#dooring">Dooring</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#ppjk">PPJK</a>
              </li>
            </ul>
          <!-- ******** -->
          <!-- ManPower -->
          <!-- ******** -->
            ...
            <div class="tab-content">
              <div id="manpower" class="container tab-pane active"><br>
                <h3>Man Power</h3>
                <div class="form-group">
                    ...
                    <div class="email">
                      ...
                      <?php
                        $no = 1;
                        echo $title;
                        foreach($datacustomer as $hasil){
                          echo "<option>".$hasil->namavendor."</option>";  
                        }  
                      ?>
                      </select>
          ...
          <!-- --REPO-- -->
          <!-- ******** -->
          <div id="repo" class="container tab-pane fade"><br>
                <h3>Menu 1</h3>
          ...
          <!-- -DOORING -->
          <!-- ******** -->
          <div id="dooring" class="container tab-pane fade"><br>
                <h3>Menu 2</h3>
          ...
          <!-- --PPJK-- -->
          <!-- ******** -->
          <div id="ppjk" class="container tab-pane fade"><br>
                <h3>Menu 3</h3>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
              </div>
            </div>
