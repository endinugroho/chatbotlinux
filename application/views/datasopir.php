...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container" style="margin-top: 30px">
        ...
        <a href="<?php echo base_url() ?>index.php/sopir/tambah/" class="btn btn-md btn-success">Tambah Sopir</a>
        <hr>
        <!-- table -->
            ...
            <table id="tablesopir" class="table table-striped table-bordered" style="width:100%">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $hasil->manpower ?></td>
                    <td><?php echo $hasil->repo ?></td>
                    <td><?php echo $hasil->door ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>index.php/sopir/edit/<?php echo $hasil->idSopir; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/sopir/hapus/<?php echo $hasil->idSopir; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
