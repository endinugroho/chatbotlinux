        ...
        <div class="col-md-12">
            <?php echo form_open('users/update') ?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="namausers" value="<?php echo $datausers->namausers ?>" class="form-control" placeholder="Nama Users">
                <input type="hidden" value="<?php echo $datausers->idUsers ?>" name="idUsers">
              </div>
 
              <div class="form-group">
                <label for="text">User Login</label>
                <input type="text" name="userlogin" value="<?php echo $datausers->userlogin ?>" class="form-control" placeholder="Masukkan Login">
              </div>
 
              <div class="form-group">
                <label for="text">Password</label>
                <input type="text" name="password" value="<?php echo $datausers->password ?>" class="form-control" placeholder="Masukkan Password">
              </div>
 
              <div class="form-group">
                <label for="text">Email</label>
                <input type="text" name="email" value="<?php echo $datausers->email ?>" class="form-control" placeholder="Masukkan Email">
              </div>
 
              <div class="form-group">
                <label for="text">Bagian</label>
                <input type="text" name="bagian" value="<?php echo $datausers->bagian ?>" class="form-control" placeholder="Masukkan Bagian">
              </div>
