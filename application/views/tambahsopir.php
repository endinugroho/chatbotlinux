...
<head>
  ...
  <title>CSB Logistic | Tambah Sopir</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container" style="margin-top: 30px">
        <div class="col-md-12">
            <?php echo form_open('sopir/simpan') ?>
 
              <div class="form-group">
                <label for="text">Nama</label>
                <input type="text" name="Nama" class="form-control" placeholder="Masukkan Nama" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">Alamat</label>
                <input type="text" name="Alamat" class="form-control" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">Kota</label>
                <input type="text" name="Kota" class="form-control" size="50" >
              </div>
 
              <div class="form-group">
                <label for="text">No HP</label>
                <input type="text" name="NoHP" class="form-control" size="50" >
              </div>
 
              <div class="form-group">
                <label for="text">User Name</label>
                <input type="text" name="username" class="form-control" size="50" >
              </div>
 
              <div class="form-group">
                <label for="text">Password</label>
                <input type="password" name="password" class="form-control" size="50" >
              </div>
