  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container" style="margin-top: 30px">
        <div class="col-md-12">
            <?php echo form_open('harga/simpan') ?>
 
              <div class="form-group">
                <label for="text">Tujuan</label>
                <input type="text" name="tujuan" class="form-control" placeholder="Masukkan Nama" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">Harga</label>
                <input type="text" name="harga" class="form-control" size="50"><input type="hidden" name="idvendor" value="<?php echo $idVendor; ?>" class="form-control" size="50">
              </div>
 
              <div class="form-group">
                <label for="text">Tarif Sopir</label>
                <input type="text" name="hargasopir" class="form-control" size="50" >
              </div>
