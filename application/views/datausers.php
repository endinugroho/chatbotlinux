...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container" style="margin-top: 30px">
        ...
        <a href="<?php echo base_url() ?>index.php/users/tambah/" class="btn btn-md btn-success">Tambah Users</a>
        <hr>
        <!-- table -->
        <div class="table-responsive">
            <table id="table" class="table table-striped table-bordered table-hover">
                ...
                ?>
                  ...
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $hasil->namausers ?></td>
                    <td><?php echo $hasil->userlogin ?></td>
                    <td><?php echo $hasil->password ?></td>
                    <td><?php echo $hasil->email ?></td>
                    <td><?php echo $hasil->bagian ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>index.php/users/edit/<?php echo $hasil->idUsers; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/users/hapus/<?php echo $hasil->idUsers; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
