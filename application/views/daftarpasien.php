...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <small>Daftar pasien dr Nikmah</small>
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo base_url() ?>index.php/DaftarPasien/tambah/" class="btn btn-sm btn-success">Tambah Daftar Pasien</a>
            <?php echo form_open('DaftarPasien'); ?> 
  ...
  {?>
    <input class="form-control" type="date" value="<?php echo $_POST['tanggal']; ?>" name="tanggal" onchange="javascript:document.forms[1].submit();">
<?php
  } else
{?>
    <input class="form-control" type="date" value="mm / dd / yyyy" name="tanggal" onchange="javascript:document.forms[1].submit();">
<?php
} ?>
  </div>
</div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url() ?>index.php/Sekolah/edit/<?php echo $hasil->id; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/Sekolah/hapus/<?php echo $hasil->id; ?>" class="btn btn-sm btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
...
<div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $hasil->noantrian; ?></td>
                  <td>
                    <a href="<?php echo base_url() ?>index.php/DaftarPasien/hapus/<?php echo $hasil->id; ?>" class="btn btn-sm btn-danger">Hapus</a>
                  </td>
                </tr>
                <?php } ?>
              </table>
