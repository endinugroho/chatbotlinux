...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>assets/AdminLTE/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>System </b>A K</span>
    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <?php echo form_open('Pegawai'); ?> 
			
                Nama Perusahaan : <select name="perusahaan" onchange="javascript:document.forms[1].submit();"><option value="-`">-</option>
                  <?php
                    //echo $title;
                    foreach($dataperush as $hasil){                        
						if (isset($_POST['perusahaan'])) 
						{
							if ($_POST['perusahaan']==$hasil->id)
								echo "<option selected value=\"".$hasil->id."\">".$hasil->nama."</option>";  
							else
            ...
            <!-- /.box-header -->
            <div class="box-header">
            <a href="<?php echo base_url() ?>index.php/Pegawai/tambah/<?php echo $idperush ?>" class="btn btn-sm btn-success">Tambah Pegawai</a><br>
			</div>
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url() ?>index.php/Pegawai/edit/<?php echo $hasil->id; ?>" class="btn btn-sm btn-success">Edit</a><a href="<?php echo base_url() ?>index.php/Pegawai/hapus/<?php echo $hasil->id; ?>" class="btn btn-sm btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
