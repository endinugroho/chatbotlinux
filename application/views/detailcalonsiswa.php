  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        $main_menu = $this->db->get_where('menuapp', array('ismainmenu' => 0));

        foreach ($main_menu->result() as $main) {

            // Query untuk mencari data sub menu

            $sub_menu = $this->db->get_where('menuapp', array('ismainmenu' => $main->id));
...
<?php if ($method=="Edit") $hasil="update"; else $hasil="simpan"; ?>
            <?php echo form_open('CalonSiswa/'.$hasil); ?> 
             ...
             <div class="form-group">
                ...
                <label for="text">Asal SD</label>

                <input type="text" name="asalsd" value="<?php if ($method=="Edit") echo $dataperush->asalsd; ?>" class="form-control" placeholder="Masukkan No WA Server">

              </div>

              <div class="form-group">

                <label for="text">Nilai Rapor</label>

                <input type="text" name="nilairapor" value="<?php if ($method=="Edit") echo $dataperush->nilairapor; ?>" class="form-control" placeholder="Masukkan No WA Server">

              </div>

              <div class="form-group">

                <label for="text">NEM</label>

                <input type="text" name="nem" value="<?php if ($method=="Edit") echo $dataperush->nem; ?>" class="form-control" placeholder="Masukkan No WA Server">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nohp" value="<?php if ($method=="Edit") echo $dataperush->nohp; ?>" class="form-control" placeholder="Masukkan No WA Server">

              </div>
              <div class="form-group">

                <label for="text">No Penginput</label>

                <input type="text" name="nohppenginput" value="<?php if ($method=="Edit") echo $dataperush->nohppenginput; ?>" class="form-control" placeholder="Masukkan No WA Server">
