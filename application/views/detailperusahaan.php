  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <?php if ($method=="Tambah") echo "Tambah Perusahaan"; else echo "Edit Perusahaan"; ?>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Detail Perusahaan</a></li>
...
<?php if ($method=="Edit") $hasil="update"; else $hasil="simpan"; ?>
            <?php echo form_open('Perusahaan/'.$hasil); ?> 
              ...
              <div class="form-group">
                ...
                <input type="text" name="deskripsi" value="<?php if ($method=="Edit") echo $dataperush->deskripsi; ?>" class="form-control" placeholder="Masukkan Deskripsi">
             ...
             <div class="form-group">
                ...
                <input type="text" name="telepon" value="<?php if ($method=="Edit") echo $dataperush->telepon; ?>" class="form-control" placeholder="Masukkan No HP">

              </div>

             <div class="form-group">

                <label for="text">GPS Lat</label>

                <input type="text" name="gpslat" value="<?php if ($method=="Edit") echo $dataperush->gpslat; ?>" class="form-control" placeholder="Masukkan GPS Lat">

              </div>

              <div class="form-group">

                <label for="text">GPS Long</label>

                <input type="text" name="gpslong" value="<?php if ($method=="Edit") echo $dataperush->gpslong; ?>" class="form-control" placeholder="Masukkan GPS Long">
