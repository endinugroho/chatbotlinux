    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo base_url() ?>index.php/Shift/tambah/" class="btn btn-sm btn-success">Tambah Shift</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                ?>
                <tr>
                  <td><?php echo $hasil->namashift; ?></td>
                  <td><?php echo $hasil->masuk; ?></td>
                  <td><?php echo $hasil->pulang; ?></td>
                  <td><?php echo $hasil->waktubreak; ?></td>
                  <td><?php echo $hasil->afterbreak; ?></td>
                  <td><a href="<?php echo base_url() ?>index.php/Shift/edit/<?php echo $hasil->id; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/Shift/hapus/<?php echo $hasil->id; ?>" class="btn btn-sm btn-danger">Hapus</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
