...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container" style="margin-top: 30px">
        ...
        <a href="<?php echo base_url() ?>index.php/customer/tambah/" class="btn btn-md btn-success">Tambah Customer</a>
        <hr>
        <!-- table -->
        <div class="table-responsive">
            <table id="table" class="table table-striped table-bordered table-hover">
                ...
                ?>
                  ...
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $hasil->namavendor ?></td>
                    <td><?php echo $hasil->alamat ?></td>
                    <td><?php echo $hasil->kota ?></td>
                    <td><?php echo $hasil->notelepon ?></td>
                    <td><?php echo $hasil->npwp ?></td>
                    <td>
                        <a href="<?php echo base_url() ?>index.php/customer/edit/<?php echo $hasil->idVendor; ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/customer/hapus/<?php echo $hasil->idVendor; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
