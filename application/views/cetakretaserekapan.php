...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cetak Perolehan Retase Rekapan
    ...
    <div class="container" style="margin-top: 30px">
      ...
      <?php echo form_open('Laporanpdf/cetakrekapan') ?>
          <div class="form-group">
        <label for="text">Nama Pekerjaan:</label>
        <label for="text"><select name="tipepekerjaan" id="tipepekerjaan">
        ...
        <div class="form-group">
			<label for="text">Pekerjaan Repo:</label>
        <div class="radio">
          <label>
            <input type="radio" name="pekerjaan" id="shift" value="Semua">
            Semua
          </label>
        </div>
        <div class="radio">
        ...
        <div class="form-group">
          <label for="text">Dari Tanggal:</label>
          <label for="text"><input name="min" id="min" type="text"></label>
        </div>
        <div class="form-group">
          <label for="text">Sampai Tanggal:</label>
          <label for="text"><input name="max" id="max" type="text"></label>
        </div>
