            ...
            <table id="tablesopir" class="table table-striped table-bordered" style="width:100%">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>index.php/Transaksimanpower/hapus/<?php echo $hasil->idRateManpower; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
