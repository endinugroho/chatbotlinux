...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Cetak Perolehan Retase Perorangan
    ...
    <div class="container" style="margin-top: 30px">
      ...
      <?php echo form_open('Laporanpdf/cetak') ?>
        ...
        <label for="text">Nama Sopir:</label>
        <label for="text"><select name="sopir" id="sopir"><?php foreach($datasopir as $hasil){
        ?>
        <option value="<?php echo $hasil->idSopir."-".$hasil->Nama;  ?>"><?php echo $hasil->Nama; ?></option>
        <?php
        }
        ?> </select></label>
        </div>
