        ...
        <div class="col-md-12">
            <?php echo form_open('Harga/update') ?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="tujuan" value="<?php echo $dataharga->tujuan; ?>" class="form-control" placeholder="Tujuan">
                <input type="hidden" value="<?php echo $dataharga->idHarga; ?>" name="idharga"><input type="hidden" value="<?php echo $dataharga->idVendor; ?>" name="idvendor">
              </div>
 
              <div class="form-group">
                <label for="text">Harga</label>
                <input type="text" name="harga" value="<?php echo $dataharga->harga ?>" class="form-control" placeholder="Harga">
              </div>
 
              <div class="form-group">
                <label for="text">Tarif Sopir</label>
                <input type="text" name="hargasopir" value="<?php echo $dataharga->hargasopir ?>" class="form-control" placeholder="Tarif sopir">
              </div>
