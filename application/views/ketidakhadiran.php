    ...
    <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo base_url() ?>index.php/sopir/tambah/" class="btn btn-sm btn-success">Tambah Ketidakhadiran Shift</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>                        <a href="<?php echo base_url() ?>index.php/sopir/edit/" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?php echo base_url() ?>index.php/sopir/hapus/" class="btn btn-sm btn-danger">Hapus</a>
</td>
                </tr>
                <tr>
                  <td>219</td>
