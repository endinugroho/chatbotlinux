            ...
            <table id="tablesopir" class="table table-striped table-bordered" style="width:100%">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>index.php/Transaksidepo/hapus/<?php echo $hasil->idRateDoor; ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
